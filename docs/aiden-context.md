...
- Intentional idle: No
- Decision required: `accept-sahale-r2-candidate` — Owner acceptance of the exact verified and independently reviewed R2 candidate; publication remains separately unauthorized.
